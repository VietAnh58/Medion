      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-lg-7 col-md-5">
            <div class="img-box">
              <img src="{{asset('assets/images/medicines.png')}}" alt="">
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="carousel-wrap layout_padding2">
          ...
          <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-1028px, 0px, 0px); transition: all 0.25s ease 0s; width: 2742px;"><div class="owl-item cloned" style="width: 332.675px; margin-right: 10px;"><div class="item">
              <div class="box">
                ...
                <div class="img-box">
                  <img src="{{asset('assets/images/p-3.png')}}" alt="">
                </div>
                <div class="detail-box">
              ...
              <div class="box">
                ...
                <div class="img-box">
                  <img src="{{asset('assets/images/p-5.png')}}" alt="">
                </div>
                <div class="detail-box">
                  <div class="star_container">
                    <i class="fa fa-star" aria-hidden="true"></i>
              ...
              <div class="box">
                ...
                <div class="img-box">
                  <img src="{{asset('assets/images/p-4.png')}}" alt="">
                </div>
                <div class="detail-box">
                  <div class="star_container">
                    <i class="fa fa-star" aria-hidden="true"></i>
              ...
              <div class="box">
                ...
                <div class="img-box">
                  <img src="{{ asset('medion/images/p-4.jpg') }}" alt="">
                </div>
                <div class="detail-box">
                  <div class="star_container">
                    <i class="fa fa-star" aria-hidden="true"></i>
              ...
              <div class="box">
                ...
                <div class="img-box">
                  <img src="{{asset('assets/images/p-2.png')}}" alt="">
                </div>
                <div class="detail-box">
                  <div class="star_container">
                    <i class="fa fa-star" aria-hidden="true"></i>
              ...
              <div class="box">
                ...
                <div class="img-box">
                  <img src="{{asset('assets/images/p-1.png')}}" alt="">
                </div>
                <div class="detail-box">
                  <div class="star_container">
                    <i class="fa fa-star" aria-hidden="true"></i>
        ...
        <div class="carousel-wrap layout_padding2">
          ...
          <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-1028px, 0px, 0px); transition: all 0.25s ease 0s; width: 2742px;"><div class="owl-item cloned" style="width: 332.675px; margin-right: 10px;"><div class="item">
              <div class="box">
                ...
                <div class="img-box">
                  <img src="{{asset('assets/images/p-6.png')}}" alt="">
                </div>
                <div class="detail-box">
                  <div class="star_container">
                    <i class="fa fa-star" aria-hidden="true"></i>
